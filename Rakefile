...
desc 'Generate documentation for the similar_products extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'SimilarProductsExtension'
...
desc 'Test the similar_products extension.'
...
namespace :test do
  desc 'Functional test the similar_products extension.'
  ...
  desc 'Unit test the similar_products extension.'
